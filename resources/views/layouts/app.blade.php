    ...
    <div x-data="{ sidebarOpen: false }" class="flex h-screen">
        <aside
            ...
            <nav class="mt-4 px-2 space-y-1">
                ...
                <a href="{{ route('admin.products.index') }}" class="{{ $linkClasses }} {{ request()->routeIs('admin.products.*') ? $activeClasses : $inactiveClasses }}">
                    <svg class="h-5 w-5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 8h14M5 8a2 2 0 110-4h14a2 2 0 110 4M5 8v10a2 2 0 002 2h10a2 2 0 002-2V8m-9 4h4"/></svg>
                    <span>Produk</span>
                </a>

                <a href="{{ route('admin.orders.index') }}" class="{{ $linkClasses }} {{ request()->routeIs('admin.orders.*') ? $activeClasses : $inactiveClasses }}">
